...
public class EngineeringYear extends AppCompatActivity {
    private User user;
    ...
    private DatabaseReference reference = database.getReference().child("Semester");
    private String title;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_engineering_year);
        init();
    }
    ...
    public void SetTags(){
        reference.orderByChild("category").equalTo("Semester").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void Back() {
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(EngineeringYear.this, Engineering.class);
