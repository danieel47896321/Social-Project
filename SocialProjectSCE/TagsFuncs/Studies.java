...
public class Studies extends AppCompatActivity {
    ...
    private DatabaseReference reference = database.getReference().child("Studies");
    @Override
    ...
    public void SetTags(){
        reference.orderByChild("category").equalTo("Studies").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
