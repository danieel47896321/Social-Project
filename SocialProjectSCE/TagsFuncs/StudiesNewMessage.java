...
public class StudiesNewMessage extends AppCompatActivity {
        private User user;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_studies_new_message);
            init();
        }
        public void init(){
            ...
            reference = database.getReference().child(user.getStudy());
            OK();
            Cancel();
        }
        public void OK(){
            buttonOk.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(FullMsg.length()>0) {
                        ...
                        Toast.makeText(StudiesNewMessage.this, "you must enter text", Toast.LENGTH_LONG).show();
                }
            });
        }
        public void Cancel(){
